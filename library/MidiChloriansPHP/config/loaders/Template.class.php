...
use MidiChloriansPHP\mvc\Template as TemplateManager;
...
class Template extends Loader {
    ...
    public function load(Reader $reader) {
        ...
        foreach ($templates as $name => $datas) {
            ...
            // Add
            TemplateManager::addTemplate($name, TemplateManager::factory($datas['adaptater'], $params, 'MidiChloriansPHP\mvc\template\adaptaters', 'MidiChloriansPHP\mvc\template\IAdaptater'), true);
        }
    }
