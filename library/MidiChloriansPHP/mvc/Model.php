...
use MidiChloriansPHP\pattern\Factory;
use MidiChloriansPHP\mvc\model\Entity;

class Model {

    use \MidiChloriansPHP\pattern\Singleton;

    protected static $_entitiesNamespace = 'models\entities';
    protected static $_reposteriesNamespace = 'models\reposteries';
    protected static $_queryBuilderNamespace = 'MidiChloriansPHP\mvc\model\queryBuilder';
    ...
    public static function factoryEntity($entityName, $entityDatas = array(), $mapColumns = true, $mapRelations = true) {
        $entity = Factory::factory($entityName, $entityDatas, self::getEntitiesNamespace(), null, false, true, 'MidiChloriansPHP\mvc\model\Entity', true);
    ...
    public function detach($entity) {
        ...
        if (is_object($entity)) {
            if (!$entity instanceof Entity)
                throw new \Exception('Entity must an instance of MidiChloriansPHP\mvc\model\Entity');
