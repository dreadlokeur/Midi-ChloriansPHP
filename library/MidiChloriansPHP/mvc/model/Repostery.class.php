...
use MidiChloriansPHP\mvc\model\Table;
use MidiChloriansPHP\pattern\Factory;
use MidiChloriansPHP\mvc\model\IQueryBuilder;
...
class Repostery {
    ...
    public function mapping($forceMap = false) {
        ...
        $builder = Factory::factory($queryBuilderName, array(), $queryBuilderNs, 'MidiChloriansPHP\mvc\model\IQueryBuilder');
