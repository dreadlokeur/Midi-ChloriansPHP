...
use MidiChloriansPHP\Database as DatabaseManager;
use MidiChloriansPHP\database\Server;
...
class Database extends Loader {
    ...
    public function load(Reader $reader) {
        ...
        foreach ($databases as $name => $datas) {
            ...
            $database = new DatabaseManager($name, $datas['type'], DatabaseManager::factory($datas['adaptater'], $name, 'MidiChloriansPHP\database\adaptaters', 'MidiChloriansPHP\database\IAdaptater'));
