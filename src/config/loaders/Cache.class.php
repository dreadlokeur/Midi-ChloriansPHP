...
use MidiChloriansPHP\Cache as CacheManager;
...
class Cache extends Loader {
    ...
    public function load(Reader $reader) {
        ...
        foreach ($caches as $cacheName => $cacheValue) {
            ...
            // Add cache
            CacheManager::addCache($cacheName, CacheManager::factory($params['adaptater'], $params, 'MidiChloriansPHP\cache\adaptaters', 'MidiChloriansPHP\cache\IAdaptater'), true);
        }
    }
