...
class Autoloader {
    ...
    public static function registerAutoloader($loaderName, $loaderArguments = array(), $throw = true, $prepend = false, $forceReplace = false) {
        ...
        if (!in_array('MidiChloriansPHP\autoloader\IAdaptater', $loaderInstance->getInterfaceNames()))
            throw new \Exception('Loader class must be implement MidiChloriansPHP\autoloader\IAdaptater');
