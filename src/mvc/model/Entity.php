...
use MidiChloriansPHP\mvc\model\Annotation;
use MidiChloriansPHP\mvc\model\Column;
use MidiChloriansPHP\mvc\model\Relation;
use MidiChloriansPHP\mvc\model\Repostery;
...
abstract class Entity {
    ...
    public function mapping($columns = true, $relations = true, $forceMap = false, $chekMap = false) {
        ...
        if ($noAnnotation && !class_exists('\\' . Model::getReposteriesNamespace() . '\\' . ucfirst($reposteryName)))
            ...
            $repostery = Factory::factory($reposteryName, array(), Model::getReposteriesNamespace(), null, false, true, 'MidiChloriansPHP\mvc\model\Repostery', true);
